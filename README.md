...
The ABP also supports a subset of the [SynSCAN protocol](https://inter-static.skywatcher.com/downloads/synscanserialcommunicationprotocol_version33.pdf) over the network. This allows the Driver to support mobile applications like [Stellariium Mobile PLUS](https://stellarium-labs.com/stellarium-mobile-plus/) or [Sky Safari 7 Plus and Pro](https://skysafariastronomy.com/).
