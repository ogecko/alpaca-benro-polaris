      ...
      <div v-else>
       ...
       The Alpaca Driver provides several network services for external aplications to use the Benro Polaris.
        ...
        <div class="row q-pl-md q-gutter-lg">
            <q-input v-model="cfg.polaris_ip_address" label="Polaris IP" @update:model-value="putdb({polaris_ip_address: cfg.polaris_ip_address})" />
        ...
        <div >
            <div class="row q-pl-md q-gutter-lg">
                <q-input type="number" v-model.number="cfg.site_latitude" label="Latitude" @update:model-value="putdb({site_latitude: cfg.site_latitude})" :class="{ taflash: taKey=='latlon'}"/>
                <q-input type="number" v-model.number="cfg.site_longitude" label="Longitude" @update:model-value="putdb({site_longitude: cfg.site_longitude})" :class="{ taflash: taKey=='latlon'}"/>
            </div>
        </div>
        <div class="row q-pl-md q-gutter-lg">
            <q-input type="number" v-model.number="cfg.site_elevation" label="Elevation (m)" @update:model-value="putdb({site_elevation: cfg.site_elevation})" />
            <q-input type="number" v-model.number="cfg.site_pressure" label="Pressure (hPa)" @update:model-value="putdb({site_pressure: cfg.site_pressure})" />
        </div>
        <div class="row q-pl-md q-gutter-lg">
            <q-input type="number" v-model.number="cfg.focal_length" label="Focal Length (mm)" @update:model-value="putdb({focal_length: cfg.focal_length})" />
            <q-input type="number" v-model.number="cfg.focal_ratio" label="Focal Ratio (f-stop)" @update:model-value="putdb({focal_ratio: cfg.focal_ratio})" />
        </div>
