  ...
  <q-page class="q-pa-md">
    ...
    <q-card flat bordered class="q-pa-md">
      ...
      <div v-if="cfg.fetchedAt">
        ...
        <div class="row q-pl-md q-gutter-lg">
            <q-input type="number" v-model.number="cfg.site_latitude" label="Latitude" @update:model-value="put('site_latitude', cfg.site_latitude)" />
            <q-input type="number" v-model.number="cfg.site_longitude" label="Longitude" @update:model-value="put('site_longitude', cfg.site_longitude)" />
        </div>
        <div class="row q-pl-md q-gutter-lg">
...
function setFromPhoneLocation() {
  if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition((pos) => {
      cfg.site_latitude = pos.coords.latitude
      cfg.site_longitude = pos.coords.longitude
    }, (err) => {
