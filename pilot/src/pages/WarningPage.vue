<template>
  <div class="fullscreen dark-page text-white text-center q-pa-md flex flex-center">
    <div>
      <div class="flash" style="font-size: 20vb">500</div>
      <div class="text-h3" style="opacity: 0.4">Use at own risk...</div>
      <div class="row">
      <div class="col-2"></div>
      <div class="col-8 text-caption " style="opacity: 0.4">
        <div class="q-pa-sm">
       Please be aware that this is not official Benro Software. If you decide to use it - you are doing so at your own risk.
        </div>
        <div class="q-pa-sm">
        There is a chance of voiding the warranty or damaging your Benro Polaris hardware. The risk is elevated more than v1.0 as the Alpaca Driver will be in direct control of the Benro Polaris during movement. There is a chance that you may use the driver/hardware in a way, unintended by its design. The driver is not official Benro software. They may not support you. 
        </div>
        <div class="q-pa-sm">
