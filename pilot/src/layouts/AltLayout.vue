...
const links5 = [
  { icon: 'mdi-account-tie-hat', text: 'Pilot', toExternal: 'https://github.com/ogecko/alpaca-benro-polaris/blob/dev2_2/docs/pilot.md' },
  ...
  { icon: 'mdi-youtube', text: 'Videos', toExternal: 'https://www.youtube.com/@jdm5001/featured' },
