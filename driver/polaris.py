    ...
    def getStatus(self) -> dict:
        with self._lock:
            res = {
                ...
                'dvsp': [0,0,0] if self._pid.delta_v_sp is None else self._pid.delta_v_sp.tolist(),
                'avsp': [0,0,0] if self._pid.alpha_v_sp is None else self._pid.alpha_v_sp.tolist(),
