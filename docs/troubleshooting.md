...
Check that you have installed Python 3.12.7 and pip 24.2. You can verify that python and pip are installed and accessible with the following commands:
...
1. Download the Python 3.12.7 installer from the official Python website.
