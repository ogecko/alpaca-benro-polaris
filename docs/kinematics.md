...
| Physical Errors | Polar Misalignment      | Cone Error                                     | A misalignment between the optical axis and the mount's declination axis causes the telescope to trace a cone rather than a great circle during slews, producing position-dependent pointing errors. | Multi-Point Alignment (QUEST v2.0)           |
