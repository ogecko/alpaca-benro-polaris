...
- **[Wi-Fi Join]** The Alpaca Pilot Connect Page's Wi-Fi button now enables Polaris Wifi and joins the Polaris hotspot network - no more manually finding `polaris_xxxxxx` in Windows' Wi-Fi list.
